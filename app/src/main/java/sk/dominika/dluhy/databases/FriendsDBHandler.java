...
import sk.dominika.dluhy.kindOfBackend.AddFriend;
    ...
    public class FriendsDBHandler extends SQLiteOpenHelper {
        ...
        public void addFriendToDatabase(AddFriend friend) {
        ...
        public List<AddFriend> getFriendFromDatabase() {
            ...
            if (cursor.moveToFirst()) {
                do{
                    AddFriend fr = new AddFriend(cursor.getString(1), cursor.getString(2));
                    list.add(fr);
